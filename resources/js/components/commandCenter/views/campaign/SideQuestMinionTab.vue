                ...
                <v-col cols="12">
                    <v-row no-gutters justify="space-between" align="center">
                        ...
                        <v-row no-gutters justify="end">
                            <div style="width: 70px">
                                <CombatPositionIcon :combat-position-id="minion.combatPositionID" :with-prefix="false"
                                                    :attacker-mode="false"></CombatPositionIcon>
                            </div>
                        </v-row>
                    </v-row>
                    <v-row class="no-gutters">
                        <v-col cols="12" class="px-1">
                            ...
                            <AttackPanel v-for="attack in minion.attacks" v-bind:key="attack.name"
                                         :attack="attack"></AttackPanel>
                        </v-col>
                    </v-row>
                </v-col>
            </v-row>
