...
@section('body')
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <h1 class="font-bold text-3xl my-2 text-center">Terms and Conditions for Roster Heroes</h1>

        <h2 class="font-semibold text-xl my-1 underline">Introduction</h2>

        <p>These Website Standard Terms and Conditions written on this webpage shall manage your use of our website,
            Roster Heroes accessible at rosterheroes.com.</p>
        ...
        <p>These Terms will be applied fully and affect to your use of this Website. By using this Website, you agreed
            ...
            of the <a href="https://www.termsandcondiitionssample.com">Terms And Conditions Template</a> and the <a
                href="https://www.terms-conditions-generator.com">Terms and Conditions Generator</a>.</p>

        <p>Anyone under the age of 13 must have permission from their legal guardian to use this site and have their
            legal guardian reviews these terms and conditions.</p>

        <h2 class="font-semibold text-xl my-1 underline">Intellectual Property Rights</h2>

        <p>Other than the content you own, under these Terms, Roster Heroes and/or its licensors own all the
            intellectual property rights and materials contained in this Website.</p>

        <p>You are granted limited license only for purposes of viewing the material contained on this Website.</p>

        <h2 class="font-semibold text-xl my-1 underline">Restrictions</h2>

        <p>You are specifically restricted from all of the following:</p>

        <ul class="list-disc px-8 my-2">
        ...
        <p>Certain areas of this Website are restricted from being access by you and Roster Heroes may further restrict
        ...
        <h2 class="font-semibold text-xl my-1 underline">Your Content</h2>

        <p>In these Website Standard Terms and Conditions, "Your Content" shall mean any audio, video text, images or
            other material you choose to display on this Website. By displaying Your Content, you grant Roster Heroes a
        ...
        <p>Your Content must be your own and must not be invading any third-party’s rights. Roster Heroes reserves the
            right to remove any of Your Content from this Website at any time without notice.</p>

        <h2 class="font-semibold text-xl my-1 underline">Your Privacy</h2>

        <p>Please read Privacy Policy.</p>

        <h2 class="font-semibold text-xl my-1 underline">No warranties</h2>

        <p>This Website is provided "as is," with all faults, and Roster Heroes express no representations or
        ...
        <h2 class="font-semibold text-xl my-1 underline">Limitation of liability</h2>

        <p>In no event shall Roster Heroes, nor any of its officers, directors and employees, shall be held liable for
            anything arising out of or in any way connected with your use of this Website whether such liability is
            under contract.  Roster Heroes, including its officers, directors and employees shall not be held liable for
            any indirect, consequential or special liability arising out of or in any way related to your use of this
            Website.</p>

        <h2 class="font-semibold text-xl my-1 underline">Indemnification</h2>

        <p>You hereby indemnify to the fullest extent Roster Heroes from and against any and/or all liabilities, costs,
        ...
        <h2 class="font-semibold text-xl my-1 underline">Severability</h2>
        ...
        <h2 class="font-semibold text-xl my-1 underline">Variation of Terms</h2>

        <p>Roster Heroes is permitted to revise these Terms at any time as it sees fit, and by using this Website you
            are expected to review these Terms on a regular basis.</p>

        <h2 class="font-semibold text-xl my-1 underline">Assignment</h2>

        <p>Roster Heroes is allowed to assign, transfer, and subcontract its rights and/or obligations under these
        ...
        <h2 class="font-semibold text-xl my-1 underline">Entire Agreement</h2>

        <p>These Terms constitute the entire agreement between Roster Heroes and you in relation to your use of this
