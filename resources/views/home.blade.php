...
<nav id="header" class="fixed w-full z-30 top-0 text-white">
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="block lg:hidden pr-4">
            <button id="nav-toggle" class="flex items-center p-1 toggleColour hover:text-gray-900">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
            ...
            <a class="mx-auto lg:mx-0 mt-4 lg:mt-0" href="/register">
                <button id="navAction" class="hover:underline bg-white text-gray-800 font-bold rounded-full py-4 px-8 shadow opacity-75">Register</button>
            </a>
        </div>
    </div>
...
<!--Hero-->
<div class="pt-12 mt-2 md:pt-24 pb-6">
    <div class="bg-orange-300 text-center py-2 md:py-4 lg:px-4">
    ...
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex pt-2 flex-col w-full md:w-1/3 justify-center items-start text-center lg:text-left">
            ...
            <div class="flex flex-col w-full justify-center">
                @svg('rh-hero-logo', 'my-4 h-40 lg:h-64 lg:mt-5 lg:mb-6')
            </div>
        ...
        <div class="w-full md:w-2/3 py-6 text-center">
            <img class="w-full z-50" src="{{asset('/images/rh_mobile_screens.png')}}">
        </div>
...
<div class="relative -mt-12 lg:-mt-24">
    <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <g transform="translate(-4.000000, 76.000000)" fill="#d5e1e8" fill-rule="nonzero">
...
<section class="py-8" style="background-color: #d5e1e8">
...
<section class="container mx-auto text-center py-6 mb-12">
    ...
    <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-white">Join the Action</h1>
    <div class="w-full mb-4">
        <div class="h-1 mx-auto bg-white w-1/6 opacity-25 my-0 py-0 rounded-t"></div>
    </div>

    <h3 class="my-4 text-3xl leading-tight">Register today and start playing for free!</h3>

    <a class="mx-auto lg:mx-0 mt-4 lg:mt-0" href="/register">
        <button class="hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg">Register</button>
    </a>
